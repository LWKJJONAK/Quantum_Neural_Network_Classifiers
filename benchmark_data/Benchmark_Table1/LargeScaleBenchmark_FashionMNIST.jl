...
@everywhere begin
    ...
    function f(i_::Int64)
        ...
        for rep in 1:repeat_
            ...
            matwrite("CODE/Github_ClassifierProject/amplitude_encode/BenchmarkData_Table1/FashionMNIST_20220419_Ent"*string(Ent_index)*"_Dep"*string(D_index)*"_"*string(rep)*".mat", Dict(
