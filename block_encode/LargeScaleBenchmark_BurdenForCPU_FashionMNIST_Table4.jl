...
@everywhere begin    
    function f(i_::Int64)
        ...
        for rep in 1:repeat_
            ...
            matwrite("CODE/Github_ClassifierProject/block_encode/BenchmarkData_Table4/FashionMNIST_20220426_Ent"*string(Ent_index)*"_Scal"*string(Scal_index)*"_"*string(rep)*".mat", Dict(
