...
@everywhere begin
    vars = matread("QNN/dataset/SPT_8qubit_wk.mat")
...
@everywhere begin
    function f(i_::Int64)
        ...
        for rep in 1:repeat_
            ...
            matwrite("QNN/amplitude_encode/BenchmarkData_Table3/SPT8qubit_20220429_Dep"*string(D_index)*"_Ent"*string(Ent_index)*"_"*string(rep)*".mat", Dict(
